...
export class SimulationResults {
    private _numTransmissions: number;
    private _numSuccessfulTransmissions: number;
    private _numTimeSlots: number;
    private _timeTransmitting: number;
    private readonly _numSlotsRadioOn: Map<string, number>;
    ...
    constructor() {
        ...
        this._numSlotsRadioOn = new Map<string, number>();
    }
     ...
     * @param timeTook
     */
    addTransmission(successful: boolean, timeTook: number) {
        this._numTransmissions++;
        if (successful) this._numSuccessfulTransmissions++;
     ...
     */
    addRadiosOnInSlot(radiosOn: string[]) {
        this._numTimeSlots++;
     ...
     * @param results
     */
    appendResults(results: SimulationResults) {
