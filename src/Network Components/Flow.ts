 ...
 */
export class Flow {
    private static nextId = 0; //used to assign unique id if not given
    ...
    hops: Hop[];
    nodeWithMsg: string;
    timeSlotsUsedToTransmit: number;
     ...
     */
    constructor(source: string, destination: string, id = -1) {
        this.source = source;
     ...
     */
    get successfullyTransmitted(): boolean {
